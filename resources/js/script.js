//Day 177 Lesson 6
var practice = [['dog', './resources/audio/dog.mp3'], ['Spot','./resources/audio/spot.mp3'], ['fat','./resources/audio/fat.mp3'], ["Dan's",'./resources/audio/dans.mp3']];
var index = 0;
var wait = 0;
var times = 0;
var click = 0;
...
$yes.click(function() {
  ...
  var audio = new Audio('./resources/audio/explain6.mp3');
  audio.play();
}); //closes yes
